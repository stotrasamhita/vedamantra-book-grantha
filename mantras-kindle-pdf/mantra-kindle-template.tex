...
\usepackage[paperwidth=104.5mm,paperheight=139.5mm,left=6mm,right=6mm,top=9mm,bottom=9mm]{geometry}
\addtolength{\headsep}{-8mm}
\addtolength{\footskip}{-4mm}
% \addtolength{\textheight}{8mm}
\setmainfont[Scale=0.50,Script=Grantha]{Noto Serif Grantha}
\newcommand\ul[1]{%
\raisebox{-3pt}{\hspace{0.25ex}\underline{\hspace{-0.25ex}\raisebox{3pt}{\smash{{#1}}}\hspace{-0.25ex}}}\hspace{0.25ex}}
